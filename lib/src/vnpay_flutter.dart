          ...
          child: Scaffold(
            ...
            body: InAppWebView(
              ...
              initialSettings: InAppWebViewSettings(
                ...
                // Allow pages to request opening a new window (e.g. bank
                // OTP/3D-Secure pages calling window.open()). Must be paired
                // with onCreateWindow below, otherwise the popup is created
                // with no host to render into and the WebView goes blank.
              ...
              // Called when a page tries to open a new window (target="_blank",
              // window.open(), etc). We never create a real second window —
              // instead we either resolve it as a callback/external-app link,
              // or load its request into the same controller. Without this,
              // supportMultipleWindows leaves the popup with no visible host
              // and the main WebView appears blank.
